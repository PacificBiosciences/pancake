...
AlignmentResult AlignerSES1::Global(const std::string_view qseq, const std::string_view tseq)
{
    ...
    auto aln = SESAlignBanded<SESAlignMode::Global, SESTracebackMode::Enabled>(
...
AlignmentResult AlignerSES1::Extend(const std::string_view /*qseq*/,
