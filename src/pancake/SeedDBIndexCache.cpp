    ...
    while (true) {
        ...
        switch (token) {
            ...
            case 'P':
                ...
                break;
            case 'F':
                numReadItems = std::sscanf(&line[1], "%d %s %d %" SCNd64, &(fl.fileId), buff,
                ...
                break;
            case 'S':
                numReadItems = std::sscanf(&line[1], "%d %s %d %" SCNd64 " %" SCNd64 " %d %d",
                ...
                break;
            case 'B':
                numReadItems = std::sscanf(&line[1], "%d %d %d %" SCNd64, &(bl.blockId),
