...
#ifndef PANCAKE_OVERLAP_WRITER_SAM_HPP
#define PANCAKE_OVERLAP_WRITER_SAM_HPP
...
{
public:
    OverlapWriterSAM(std::FILE* fpOut, bool writeIds, bool writeCigar);
...
#endif  // PANCAKE_OVERLAP_WRITER_SAM_HPP
